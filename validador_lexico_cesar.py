...
# -*- coding: utf-8 -*-
"""
Validador del Analizador Léxico - CESAR DELGADO
...
archivo_java = "PruebaCesarDelgado.java"
...
log_content.append("VALIDACIÓN DEL ANALIZADOR LÉXICO - CESAR DELGADO")
log_content.append("=" * 80)
log_content.append(f"Fecha y Hora: {ahora.strftime('%d de %B de %Y - %H:%M:%S')}")
log_content.append(f"Archivo Analizado: {archivo_java}")
log_content.append(f"Tokens del Integrante: Identificadores, Literales, Operadores Aritméticos, Incremento/Decremento, Asignaciones, Comparadores")
log_content.append("=" * 80)
...
while True:
    ...
    descripcion_tokens = {
        ...
        'PLUS_ASSIGN': 'Asignación suma (+=)',
        'MINUS_ASSIGN': 'Asignación resta (-=)',
        'TIMES_ASSIGN': 'Asignación multiplicación (*=)',
        'DIVIDE_ASSIGN': 'Asignación división (/=)',
        'MOD_ASSIGN': 'Asignación módulo (%=)',
        'COLON': 'Dos puntos',
        'STRING_LITERAL': 'Literal de cadena',
        'CHAR_LITERAL': 'Literal de carácter',
