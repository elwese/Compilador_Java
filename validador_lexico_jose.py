...
# -*- coding: utf-8 -*-
"""
Validador del Analizador Léxico - JOSE SALAZAR
...
archivo_java = "PruebaJoseSalazar.java"
...
log_content.append("VALIDACIÓN DEL ANALIZADOR LÉXICO - JOSE SALAZAR")
log_content.append("=" * 80)
log_content.append(f"Fecha y Hora: {ahora.strftime('%d de %B de %Y - %H:%M:%S')}")
log_content.append(f"Archivo Analizado: {archivo_java}")
log_content.append(f"Tokens del Integrante: Asignación, Comparadores, Operadores Lógicos, Delimitadores, Puntuación, Comentarios")
log_content.append("=" * 80)
